...
- **Universe:** 1,007 unique domains across 38 verticals (350 curated AI vendors + 484 Fortune 500 + 28 Forbes AI 50 + 18 hand-picked HealthTech AI + 12 hand-picked K-12 EdTech + 49 .kineticgain.com operator surfaces + 64 hand-picked CISO procurement targets across AI security / GRC / vendor risk / DevSecOps / IAM / OT-IoT / SecOps / MLOps + reference dogfood). Crossed the long-arc 1,000-domain target on 2026-05-28. Up from 37 at Issue #1. **Latest baseline snapshot** at [`data/baseline-2026-05-28.json`](data/baseline-2026-05-28.json): 1 publisher (KG), 0.10% rate, verifiedRate 1.0.
